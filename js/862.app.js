(self["webpackChunkgestion"] = self["webpackChunkgestion"] || []).push([[862],{
...
__webpack_require__.d(__webpack_exports__, {
  "default": () => (/* reexport */ rehypeHighlight)
});

// EXTERNAL MODULE: ./node_modules/unist-util-is/lib/index.js
var lib = __webpack_require__(9143);
...
// EXTERNAL MODULE: ./node_modules/hast-util-is-element/lib/index.js
var hast_util_is_element_lib = __webpack_require__(9747);
...
const br = (0,hast_util_is_element_lib/* convertElement */.a)('br')
const cell = (0,hast_util_is_element_lib/* convertElement */.a)(isCell)
const p = (0,hast_util_is_element_lib/* convertElement */.a)('p')
const row = (0,hast_util_is_element_lib/* convertElement */.a)('tr')

// Note that we don’t need to include void elements here as they don’t have text.
// See: <https://github.com/wooorm/html-void-elements>
const notRendered = (0,hast_util_is_element_lib/* convertElement */.a)([
...
const blockOrCaption = (0,hast_util_is_element_lib/* convertElement */.a)([
...
const PSEUDO_SELECTORS = less_PSEUDO_CLASSES.concat(less_PSEUDO_ELEMENTS).sort().reverse();
...
var lib_default = __webpack_require__(7471);
// EXTERNAL MODULE: ./node_modules/highlight.js/lib/core.js
var core = __webpack_require__(8416);
...
function createLowlight(grammars) {
  const high = es_core.newInstance()
  ...
  function highlight(language, value, options) {
    ;(0,lib_default.ok)(typeof language === 'string', 'expected `string` as `name`')
    ;(0,lib_default.ok)(typeof value === 'string', 'expected `string` as `value`')
  ...
  function register(grammarsOrName, grammar) {
    if (typeof grammarsOrName === 'string') {
      (0,lib_default.ok)(grammar !== undefined, 'expected `grammar`')
  ...
  function registerAlias(aliasesOrName, alias) {
    if (typeof aliasesOrName === 'string') {
      (0,lib_default.ok)(alias !== undefined)
...
var unist_util_visit_lib = __webpack_require__(7970);
...
function rehypeHighlight(options) {
  ...
  return function (tree, file) {
    (0,unist_util_visit_lib/* visit */.YR)(tree, 'element', function (node, _, parent) {
      if (
        node.tagName !== 'code' ||
        !parent ||
        parent.type !== 'element' ||
