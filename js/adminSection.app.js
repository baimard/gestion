...
var toastify = __webpack_require__(8588);
...
var FilePicker = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
...
var FilePickerBuilder = /*#__PURE__*/(/* unused pure expression or super */ null && (function () {
...
var $$3 = _export;
var dist_assign = objectAssign;

// `Object.assign` method
// https://tc39.es/ecma262/#sec-object.assign
// eslint-disable-next-line es/no-object-assign -- required for testing
$$3({ target: 'Object', stat: true, arity: 2, forced: Object.assign !== dist_assign }, {
  assign: dist_assign
});
...
var dist_isPrototypeOf = objectIsPrototypeOf;
...
var regexpGetFlags = function (R) {
  var flags = R.flags;
  return flags === undefined && !('flags' in RegExpPrototype$2) && !hasOwn(R, 'flags') && dist_isPrototypeOf(RegExpPrototype$2, R)
...
var dist_hasOwnProperty = objectProto.hasOwnProperty;
...
var reIsNative = RegExp('^' +
  funcToString.call(dist_hasOwnProperty).replace(reRegExpChar, '\\$&')
...
function hashGet(key) {
  ...
  return dist_hasOwnProperty.call(data, key) ? data[key] : undefined;
}
...
function hashHas(key) {
  var data = this.__data__;
  return nativeCreate ? data[key] !== undefined : dist_hasOwnProperty.call(data, key);
}
 ...
 * @param options
 */
function dist_showMessage(data, options) {
  var _Toastify;
  var _a;
 ...
 * @param options
 */
function dist_showError(text, options) {
  return dist_showMessage(text, Object.assign(Object.assign({}, options), {
 ...
 * @param options
 */
function dist_showSuccess(text, options) {
  return dist_showMessage(text, Object.assign(Object.assign({}, options), {
...
function showUndo(text, onUndo, options) {
  ...
  undoButton.innerText = dist_t('Undo');
  ...
  toast = dist_showMessage(undoContent, Object.assign(Object.assign({}, options), {
    type: ToastType.UNDO
  }));
  return toast;
}
...
;// CONCATENATED MODULE: ./node_modules/@nextcloud/l10n/dist/index.mjs
 ...
 */
function dist_getCanonicalLocale() {
    return dist_getLocale().replace(/_/g, '-');
}
/**
 * Returns the user's language
 */
function dist_getLanguage() {
    return document.documentElement.lang || 'en';
}
/**
 * Translate a string
 ...
 * @return {string}
 */
function dist_translate(app, text, vars, number, options) {
    ...
    const optEscape = allOptions.escape ? escape_html : identity;
 ...
 * @param {object} options options object
 */
function dist_translatePlural(app, textSingular, textPlural, number, vars, options) {
    ...
    if (typeof value !== 'undefined') {
        ...
        if (Array.isArray(translation)) {
            ...
            return dist_translate(app, translation[plural], vars, number, options);
        }
    }
    if (number === 1) {
        return dist_translate(app, textSingular, vars, number, options);
    }
    else {
        return dist_translate(app, textPlural, vars, number, options);
    }
}
/**
...
function loadTranslations(appName, callback) {
    if (hasAppTranslations(appName) || dist_getLocale() === 'en') {
        return Promise.resolve().then(callback);
    }
    const url = generateFilePath(appName, 'l10n', dist_getLocale() + '.json');
 ...
 * @return {string[]}
 */
function dist_getDayNamesShort() {
    if (typeof window.dayNamesShort === 'undefined') {
        console.warn('No dayNamesShort found');
        return ['Sun.', 'Mon.', 'Tue.', 'Wed.', 'Thu.', 'Fri.', 'Sat.'];
    }
 ...
 * @return {string[]}
 */
function dist_getMonthNamesShort() {
    if (typeof window.monthNamesShort === 'undefined') {
        console.warn('No monthNamesShort found');
        return [
            'Jan.',
 ...
 */
 var optionDatatable = {
    ...
    language: {
        "search": dist_translate('gestion', 'Search'),
        "emptyTable": dist_translate('gestion', 'No data available in table'),
        "info": dist_translate('gestion', 'Showing {start} to {end} of {total} entries', { start: '_START_', end: '_END_', total: '_TOTAL_' }),
        "infoEmpty": dist_translate('gestion', 'Showing 0 to 0 of 0 entries'),
        "loadingRecords": dist_translate('gestion', 'Loading records …'),
        "processing": dist_translate('gestion', 'Processing …'),
        "infoFiltered": dist_translate('gestion', '{max} entries filtered', { max: '_MAX_' }),
        "lengthMenu": dist_translate('gestion', 'Show {menu} entries', { menu: '_MENU_' }),
        "zeroRecords": dist_translate('gestion', 'No corresponding entry'),
        "paginate": {
            "first": dist_translate('gestion', 'First'),
            "last": dist_translate('gestion', 'Last'),
            "next": dist_translate('gestion', 'Next'),
            "previous": dist_translate('gestion', 'Previous'),
        }
    }
}
...
function saveNextcloud(myData) {
  ...
  function getMailServerFrom(input) {
    ...
    function backup(){
        ...
        oReq.onload = function(e){
            if (this.status == 200) {
                dist_showSuccess(dist_translate('gestion', 'Save in')+' '+JSON.parse(this.response)['name']+'\n'+dist_translate('gestion','(do not forget to show hidden folders)'));
            }else{
                dist_showError(this.response);
            }
        };
        oReq.send();
    }
