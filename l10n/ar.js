OC.L10N.register(
    ...
    "From" : "من :",
    "To" : "إلى :",
    "Separate multiple recipients by \";\"" : "فصل المُستلمِين المُتعدِّدين بـ \";\"",
    "Cc" : "نسخة كربونية Cc",
    ...
    "To add a logo, drop the logo.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "لإضافة الشعار، قم بإسقاط ملف logo.png في مجلد \"gestion.\" في جذر تطبيق Nextcloud Files. تذكر أن تقوم بتمكين \"إظهار الملفات المخفية\".",
    "This message will not appear on generated PDF." : "لن تظهر هذه الرسالة في ملف PDF الذي تم إنشاؤه.",
    "TO" : "إلى",
    "Offer valid for 1 month from" : "العرض صالح لمدة 1 شهر اعتباراً من",
    "Quantity" : "الكمية",
    ...
    "E-mail address which appears in the header of the Quote/Invoice" : "عنوان البريد الإلكتروني الذي يظهر في ترويسة عرض الأسعار / الفاتورة",
    "Mail" : "البريد",
    "TVA Default" : "قيمة الضريبة المضافة VAT التلقائية",
