OC.L10N.register(
    ...
    "Welcome to GESTION 2.0" : "Vítejte v GESTION 2.0",
    ...
    "This application is open source, it designed by Benjamin AIMARD." : "Tato aplikace je open source a navrhl ji Benjamin AIMARD.",
    ...
    "Global Default VAT rate apply to your Quote/Invoice (globally), to change it, please just insert VAT amount without the percent sign" : "Globální výchozí sazba DPH, které uplatňovat na vaše nabídky/faktury (globálně). Pokud ho chcete změnit, stačí jen zadat výši daně (bez znaku procent)",
    ...
    "Loading …" : "Načítání",
    "First name appear in the quote/invoice header as a contact" : "Jméno se objeví v záhlaví nabídky/faktury jako kontakt",
    "Last name appear in the quote/invoice header as a contact" : "Příjmení se objeví v záhlaví nabídky/faktury jako kontakt",
    "Company address appear in the quote/invoice header" : "Adresa společnosti, figurující v záhlaví nabídky/faktury",
    "Phone number appear in the quote/invoice header" : "Telefonní číslo, figurující v záhlaví nabídky/faktury",
    "Email appear in the quote/invoice header" : "E-mail, figurující v záhlaví nabídky/faktury",
    "Global Default VAT apply to your Quote/Invoice (globally), to change it, please just insert VAT amount without the percent sign" : "Globální výchozí DPH, které uplatňovat na vaše nabídky/faktury (globálně). Pokud ho chcete změnit, stačí jen zadat výši daně (bez znaku procent)",
    "Quote" : "Nabídka",
