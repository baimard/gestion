OC.L10N.register(
    ...
    "⚠️ Important Update:\n\nLogos are now associated with the company you are currently using, based on its identifier number.\n\nIn the application, at the top left of the navigation menu, you’ll see the name of your company followed by its ID (e.g., id: %s).\n\nTo apply a logo to your company, you must prefix the logo file name with this ID number.\n\nFor example, if your company ID is %s, rename your logo file from %s to %s." : "⚠️ Důležitá aktualizace:\n\nLoga jsou nyní spojována se společností, kterou právě používáte, na základě jejího identifikačního čísla.\n\nV aplikaci, vlevo nahoře v nabídce navigace, uvidíte název své společnosti, následovaný jejím identifikátorem (např. id: %s).\n\nPokud chcete použít u své společnosti logo, je třeba název souboru s ním předeslat tímto identifikačním číslem.\n\nNapříklad, pokud je ID vaší společnosti %s, přejmenujte soubor s logem z %s na %s.",
    ...
    "Activate this option for an automatically generated invoice number. To enter your own invoice number, deactivate this option. The option can be activated and deactivated at any time." : "Tuto volbu zapněte pro automatické vytváření čísla faktury. Pokud chcete zadat číslo podle sebe, pak tuto volbu vypněte. Zapínat a vypínat lze libovolně.",
