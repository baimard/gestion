OC.L10N.register(
    ...
    "# Company Management with Gestion\nGestion is a Nextcloud application designed to simplify invoicing for freelancers and micro-enterprises.\n\nKey Features:\n* Add and manage customer profiles\n* Create and customize product entries\n* Generate quotes and invoices in PDF format\n* Send PDFs directly via email from the application\n* Store generated documents securely within your Nextcloud instance\n* Track your business activities efficiently\n\n✨ The PDF generation system has been recently redesigned to improve layout, styling, and compatibility.\n\nThis application is tailored to meet the invoicing needs of small businesses, particularly within the French market. It offers a user-friendly interface and integrates seamlessly with Nextcloud's ecosystem.\n\nA presentation video is available in the user documentation to guide you through the application's features.\n\nIf you require adaptations of this application to comply with your country's regulations, please open an issue on the GitHub repository.\n\n[![Donate](https://img.shields.io/badge/Donate-Buy%20me%20a%20coffee-yellow.svg)](https://www.buymeacoffee.com/benjaminaimard)" : "# Unternehmensverwaltung mit GestionGestion ist eine Nextcloud-Anwendung, die die Rechnungsstellung für Freiberufler und Kleinunternehmer vereinfacht.Hauptfunktionen:* Kundenprofile hinzufügen und verwalten* Produkteinträge erstellen und anpassen* Angebote und Rechnungen im PDF-Format erstellen* PDFs direkt aus der Anwendung per E-Mail versenden* Generierte Dokumente sicher in deiner Nextcloud-Instanz speichern* Geschäftsaktivitäten effizient verfolgen✨ Das PDF-Generierungssystem wurde überarbeitet, um Layout, Stil und Kompatibilität zu verbessern.Diese Anwendung ist auf die Rechnungsstellungsanforderungen kleiner Unternehmen, insbesondere auf dem französischen Markt, zugeschnitten. Sie bietet eine benutzerfreundliche Oberfläche und integriert sich nahtlos in das Nextcloud-Ökosystem.In der Benutzerdokumentation finden sich ein Präsentationsvideo, das Dich durch die Funktionen der Anwendung führt.Solltest Du Anpassungen dieser Anwendung an die Vorschriften Deines Landes benötigen, erstelle bitte ein Issue im GitHub-Repository.[![Spenden](https://img.shields.io/badge/Donate-Buy%20me%20a%20coffee-yellow.svg)](https://www.buymeacoffee.com/benjaminaimard)",
