OC.L10N.register(
    ...
    "Are you sure you want to delete? (All data will be lost)" : "Biztos, hogy törölni kívánja? (Minden adat elveszik)",
    ...
    "To add a logo, drop the logo_header.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Logó hozzáadásához dobjon egy logo_header.png fájlt a „.gestion” mappába a Nextcloud Fájlok alkalmazás gyökerében. Ne felejtse el bekapcsolni a „Rejtett fájlok megjelenítése” beállítást.",
    "This message will not appear on generated PDF." : "Ez az üzenet nem fog megjelenni az előállított PDF-en.",
    "FROM" : "FELADÓ",
    "To add a logo, drop the logo.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Logó hozzáadásához dobja a logo.png fájlt a „.gestion” mappába a Nextcloud Fájlok alkalmazás gyökerében. Ne feledje bekapcsolni a „Rejtett fájlok megjelenítése\" beállítást.",
    "TO" : "CÍMZETT",
    ...
    "To add a logo, drop the logo_footer.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Logó hozzáadásához dobjon egy logo_footer.png fájlt a „.gestion” mappába a Nextcloud Fájlok alkalmazás gyökerében. Ne felejtse el bekapcsolni a „Rejtett fájlok megjelenítése” beállítást.",
    "Date:" : "Dátum:",
    "Signature:" : "Aláírás:",
    "Invoice" : "Számla",
