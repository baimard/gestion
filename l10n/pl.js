OC.L10N.register(
    ...
    "Welcome to GESTION 2.0" : "Witamy w GESTION 2.0",
    ...
    "This application is open source, it designed by Benjamin AIMARD." : "Aplikacja jest open source i została zaprojektowana przez Benjamina AIMARDA.",
    ...
    "This is the name of the company that will appears in the footer of your quote and invoice. For example, you can set : \"Company : Cybercorp\" or just \"Cybercorp\"." : "To jest nazwa firmy, która pojawi się w stopce Twojej oferty i faktury. Na przykład możesz ustawić: \"Firma: Cybercorp\" lub po prostu \"Cybercorp\".",
    ...
    "Global Default VAT rate apply to your Quote/Invoice (globally), to change it, please just insert VAT amount without the percent sign" : "Ogólna domyślna stawka VAT ma zastosowanie do Twojej Oferty/Faktury (globalnie), aby ją zmienić, wystarczy wpisać kwotę VAT bez znaku procentu.",
    ...
    "This is the name of the company that will appear in the footer of your quote and invoice.  For example, you can set : \"Company : Cybercorp\" or just \"Cybercorp\"" : "To jest nazwa firmy, która pojawi się w stopce Twojej oferty i faktury. Na przykład możesz ustawić: \"Firma: Cybercorp\" lub po prostu \"Cybercorp\"",
    "Loading …" : "Wczytywanie…",
    "First name appear in the quote/invoice header as a contact" : "Imię pojawiające się w nagłówku Oferty/Faktury jako kontakt",
    "Last name appear in the quote/invoice header as a contact" : "Nazwisko pojawiające się w nagłówku Oferty/Faktury jako kontakt",
    "Company address appear in the quote/invoice header" : "Adres firmy pojawiający się w nagłówku Oferty/Faktury",
    "Phone number appear in the quote/invoice header" : "Numer telefonu pojawiający się w nagłówku Oferty/Faktury",
    "Email appear in the quote/invoice header" : "E-mail pojawiający się w nagłówku Oferty/Faktury",
    "Global Default VAT apply to your Quote/Invoice (globally), to change it, please just insert VAT amount without the percent sign" : "Ogólny domyślny podatek VAT ma zastosowanie do Twojej Oferty/Faktury (globalnie), aby go zmienić, wystarczy wpisać kwotę VAT bez znaku procentu",
    "Quote" : "Oferta",
