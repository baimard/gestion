OC.L10N.register(
    ...
    "Your company zip code" : "O código postal da sua empresa",
    "Gestion" : "Gestão",
    "Simplified invoice management application" : "Aplicativo de gerenciamento de faturas simplificado",
    "# Company Management with Gestion\nGestion is a Nextcloud application designed to simplify invoicing for freelancers and micro-enterprises.\n\nKey Features:\n* Add and manage customer profiles\n* Create and customize product entries\n* Generate quotes and invoices in PDF format\n* Send PDFs directly via email from the application\n* Store generated documents securely within your Nextcloud instance\n* Track your business activities efficiently\n\n✨ The PDF generation system has been recently redesigned to improve layout, styling, and compatibility.\n\nThis application is tailored to meet the invoicing needs of small businesses, particularly within the French market. It offers a user-friendly interface and integrates seamlessly with Nextcloud's ecosystem.\n\nA presentation video is available in the user documentation to guide you through the application's features.\n\nIf you require adaptations of this application to comply with your country's regulations, please open an issue on the GitHub repository.\n\n[![Donate](https://img.shields.io/badge/Donate-Buy%20me%20a%20coffee-yellow.svg)](https://www.buymeacoffee.com/benjaminaimard)" : "# Gestão da empresa com o aplicativo Gestão\nO aplicativo Gestão é um aplicativo Nextcloud projetado para simplificar o faturamento para freelancers e microempresas.\n\nPrincipais recursos:\n* Adicione e gerencie perfis de clientes\n* Crie e personalize entradas de produtos\n* Gere cotações e faturas em formato PDF\n* Envie PDFs diretamente por e-mail a partir do aplicativo\n* Armazene os documentos gerados de forma segura em sua instância do Nextcloud\n* Acompanhe suas atividades comerciais com eficiência\n\n✨ O sistema de geração de PDF foi recentemente reformulado para melhorar o layout, o estilo e a compatibilidade.\n\nEste aplicativo foi desenvolvido para atender às necessidades de faturamento de pequenas empresas, especialmente no mercado francês. Ele oferece uma interface fácil de usar e se integra perfeitamente ao ecossistema do Nextcloud.\n\nUm vídeo de apresentação está disponível na documentação do usuário para orientá-lo sobre os recursos do aplicativo.\n\nSe você precisar de adaptações deste aplicativo para cumprir os regulamentos de seu país, abra um problema no repositório do GitHub.\n\n[![Doações](https://img.shields.io/badge/Donate-Buy%20me%20a%20coffee-yellow.svg)](https://www.buymeacoffee.com/benjaminaimard)",
    ...
    "Save in" : "Salvar em",
    "There is an error" : "Há um erro",
    "Fichier XML Factur-X généré et sauvegardé." : "Arquivo XML Factur-X gerado e salvo.",
    "Erreur lors de la génération du XML : " : "Erro durante a geração do XML:",
    ...
    "Génération de la facture électronique…" : "Geração da fatura eletrônica…",
    "Facture électronique générée et sauvegardée." : "Fatura eletrônica gerada e salva.",
    "Erreur lors de la génération de la facture électronique : " : "Erro ao gerar a fatura eletrônica:",
    "Génération du XML Factur-X…" : "Geração do XML Factur-X…",
    "Envoi de la facture électronique à Iopole" : "Envio da fatura eletrônica para a departamento",
    "Facture envoyée à Iopole ! Identifiant : " : "Fatura enviada para departamento! ID:",
    "Erreur lors de l'envoi à Iopole : " : "Erro ao enviar para o departamento:",
