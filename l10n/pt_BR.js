OC.L10N.register(
    ...
    "To add a logo, drop the logo_header.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Para adicionar um logotipo, coloque o arquivo logo_header.png na pasta \".gestion\" na raiz do seu aplicativo Nextcloud Arquivos. Lembre-se de definir \"Mostrar arquivos ocultos\".",
    "This message will not appear on generated PDF." : "Esta mensagem não aparecerá no PDF gerado.",
    "FROM" : "DE",
    "To add a logo, drop the logo.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Para adicionar um logotipo, solte o arquivo logo.png na pasta \".gestion\" na raiz do seu aplicativo Nextcloud Arquivos. Lembre-se de definir \"Mostrar arquivos ocultos\".",
    "TO" : "PARA",
    ...
    "To add a logo, drop the logo_footer.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Para adicionar um logotipo, solte o arquivo logo_footer.png na pasta \".gestion\" na raiz do seu aplicativo Nextcloud Arquivos. Lembre-se de definir \"Mostrar arquivos ocultos\".",
