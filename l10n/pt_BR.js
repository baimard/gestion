OC.L10N.register(
    ...
    "Welcome to GESTION 2.0" : "Bem-vindo ao GESTION 2.0",
    ...
    "This application is open source, it designed by Benjamin AIMARD." : "Este aplicativo é de código aberto, projetado por Benjamin AIMARD.",
    "If you like my work you can" : "Se você gosta do meu trabalho pode",
    ...
    "This is the name of the company that will appears in the footer of your quote and invoice. For example, you can set : \"Company : Cybercorp\" or just \"Cybercorp\"." : "Este é o nome da empresa que aparecerá no rodapé da sua cotação e fatura. Por exemplo, você pode definir: \"Empresa: Cybercorp\" ou apenas \"Cybercorp\".",
    ...
    "Global Default VAT rate apply to your Quote/Invoice (globally), to change it, please just insert VAT amount without the percent sign" : "A taxa de IVA(VAT) padrão global se aplica à sua cotação/fatura (globalmente), para alterá-la, basta inserir o valor do IVA(VAT) sem o sinal de porcentagem",
    "Automatic generated invoice number" : "Número da fatura gerada automaticamente",
    "If you want to have an automatic generated invoice number, set to enable. if you want to be free, set disable. You can enable and disable when you want." : "Se você deseja ter um número de fatura gerado automaticamente, defina para ativar. se você quiser ser livre, defina desabilitar. Você pode habilitar e desabilitar quando quiser.",
    ...
    "Loading …" : "Carregando …",
    "First name appear in the quote/invoice header as a contact" : "O primeiro nome aparece no cabeçalho da cotação/fatura como um contato",
    "Last name appear in the quote/invoice header as a contact" : "O sobrenome aparece no cabeçalho da cotação/fatura como um contato",
    "Company address appear in the quote/invoice header" : "O endereço da empresa aparece no cabeçalho da cotação/fatura",
    "Phone number appear in the quote/invoice header" : "O número de telefone aparece no cabeçalho da cotação/fatura",
    "Email appear in the quote/invoice header" : "O e-mail aparece no cabeçalho da cotação/fatura",
    "Global Default VAT apply to your Quote/Invoice (globally), to change it, please just insert VAT amount without the percent sign" : "O IVA padrão global(Global Default VAT) se aplica à sua cotação/fatura (globalmente), para alterá-lo, basta inserir o valor do IVA((VAT) sem o sinal de porcentagem",
    "Quote" : "Cotar",
