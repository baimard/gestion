OC.L10N.register(
    ...
    "You can now share a company with others users!" : "Agora você pode compartilhar uma empresa com outros usuários!",
    ...
    "To add a logo, drop the logo_header.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Para adicionar um logotipo, coloque o arquivo logo_header.png na pasta \".gestion\" na raiz do seu aplicativo Nextcloud Files. Lembre-se de definir \"Mostrar arquivos ocultos\".",
    ...
    "Loading …" : "Carregando …",
    "First name appears in the Quote/Invoice header as a contact" : "O prenome aparece no cabeçalho cotação/fatura como um contato",
    "Last name appears in the Quote/Invoice header as a contact" : "O sobrenome aparece no cabeçalho da cotação/fatura como um contato",
    ...
    "Legal disclaimer/mentions you need in your footer - before company information" : "Isenção de responsabilidade legal/menções que você precisa em seu rodapé - antes das informações da empresa",
    "Mentions Default" : "Mencões padrão",
    "COMPANY" : "EMPRESA",
    "Customers" : "Clientes",
    "Quotes" : "Cotações",
    "Invoices" : "Faturas",
