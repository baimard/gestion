OC.L10N.register(
    ...
    "Newsletter" : "Bülten",
    "You can now share a company with others users!" : "Artık bir kuruluşu diğer kullanıcılarla paylaşabilirsiniz!",
    ...
    "If you want to automatically generated an invoice number, set to enable. If you want to be free, set disable. You can enable and disable when you want." : "Bu seçenek kullanıma alındığında, fatura numarası otomatik olarak oluşturulur. Kullanımdan kaldırıldığında, numarayı kendiniz yazabilirsiniz. Bu seçeneği istediğiniz zaman kullanıma alabilir ya da kullanımdan kaldırabilirsiniz.",
    ...
    "Legal disclaimer/mentions you need in your footer - before company information" : "Alt bilgi bölümünde gereken yasal sorumluluk reddi ve anmalar. Kuruluş bilgilerinden önce",
    "Mentions Default" : "Anmalar varsayılanı",
    "COMPANY" : "KURULUŞ",
