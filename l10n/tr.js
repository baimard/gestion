OC.L10N.register(
    ...
    "There is an error" : "Bir sorun çıktı",
    "Fichier XML Factur-X généré et sauvegardé." : "Factor-X XML dosyası oluşturuldu ve kaydedildi.",
    "Erreur lors de la génération du XML : " : "XML oluşturulurken sorun çıktı:",
    ...
    "Génération de la facture électronique…" : "E-fatura oluşturuluyor…",
    "Facture électronique générée et sauvegardée." : "E-fatura oluşturuldu ve kaydedildi.",
    "Erreur lors de la génération de la facture électronique : " : "E-fatura oluşturulurken sorun çıktı:",
    "Génération du XML Factur-X…" : "Factur-X XML oluşturuluyor…",
    "Envoi de la facture électronique à Iopole" : "E-faturanın Iopole üzerine gönderiliyor",
    "Facture envoyée à Iopole ! Identifiant : " : "Fatura Iopole üzerine gönderildi! Kimlik:",
    "Erreur lors de l'envoi à Iopole : " : "Iopole üzerine gönderilirken sorun çıktı:",
    "Welcome to GESTION" : "GESTION uygulamasına hoş geldiniz",
    "⚠️ Important Update:\n\nLogos are now associated with the company you are currently using, based on its identifier number.\n\nIn the application, at the top left of the navigation menu, you’ll see the name of your company followed by its ID (e.g., id: %s).\n\nTo apply a logo to your company, you must prefix the logo file name with this ID number.\n\nFor example, if your company ID is %s, rename your logo file from %s to %s." : "⚠️ Önemli Güncelleme:\n\nLogolar artık, tanımlayıcı numarasına göre, kullanmakta olduğunuz kuruluşla ilişkilendiriliyor.\n\nUygulamada, gezinme menüsünün sol üstünde, kuruluşunuzun adını ve kimliğini (Kimlik: %s gibi) göreceksiniz.\n\nKuruluşunuza bir logo eklemek için, logo dosya adının başına bu kimlik numarasını eklemeniz gerekir.\n\nÖrneğin, kuruluş kimliğiniz %s ise, logo dosyanızın %s olan adını %s olarak değiştirin.",
    "To start with this application you need to configure your company information, follow this link" : "Bu uygulamayı kullanmaya başlamak için kuruluş bilgilerinizi eklemelisiniz. Bu bağlantıyı açın",
    ...
    "Newsletter" : "Bülten",
    "Version 2.7.0 You can now share a company with others users!" : "2.7.0 sürümü. Artık bir şirketi diğer kullanıcılarla paylaşabilirsiniz!",
    "Version 2.8.0 introduces a complete overhaul of the PDF generation system, bringing improved design, layout consistency and compatibility with more readers." : "2.8.0 sürümü, PDF oluşturma sistemi tümüyle elden geçirildi. Tasarımı iyileştirildi, düzende tutarlılık sağlandı ve daha fazla okuyucuyla uyumlu duruma getirildi.",
    ...
    "To add a logo, drop the <compagnyid>logo_footer.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "Logo eklemek için <compagnyid>logo_footer.png dosyanızı sürükleyip Nextcloud Dosyalar uygulamanızın kök klasöründeki \".gestion\" klasörüne bırakın. Klasörü görebilmek için \"Gizli dosyalar görüntülensin\" seçeneğini açmayı unutmayın",
