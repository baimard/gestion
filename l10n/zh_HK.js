OC.L10N.register(
    ...
    "QUOTE" : "報價",
    "PDF créé avec succès." : "PDF 已成功創建。",
    "Erreur lors de la création du PDF." : "PDF 創建時出現錯誤。",
    ...
    "To add a logo, drop the logo_header.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "要添加徽標，請將 logo_header.png 檔案放在 Nextcloud Files 應用程式根目錄下的「.gestion」資料夾中。記得啟用「顯示隱藏檔案」。",
    "This message will not appear on generated PDF." : "此訊息不會顯示在產生的 PDF 檔案中。",
    "FROM" : "由",
    "To add a logo, drop the logo.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "要添加徽標，請將 logo.png 檔案放在 Nextcloud Files 應用程式根目錄下的「.gestion」資料夾中。記得啟用「顯示隱藏檔案」。",
    "TO" : "致",
    "Add product" : "添加商品",
    ...
    "To add a logo, drop the logo_footer.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "要添加徽標，請將 logo_footer.png 檔案放在 Nextcloud Files 應用程式根目錄下的「.gestion」資料夾中。記得啟用「顯示隱藏檔案」。",
