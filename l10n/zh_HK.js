OC.L10N.register(
    ...
    "Version 3.1.0 focuses on electronic invoicing and prepares Gestion for the French e-invoicing transition." : "3.1.0 版本專注於電子發票功能，並為法國電子發票制度轉型作好準備。",
    ...
    "The MIAGE class at the University of Bordeaux" : "波爾多大學 MIAGE 課程",
    "for the extraordinary work on the application this year" : "感謝其今年對本應用程式所作出的卓越貢獻。",
    "for the coffee ;)" : "的咖啡；）",
    ...
    "To add a logo, drop the <compagnyid>logo_header.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "要添加徽標，請將 <compagnyid>logo_header.png 檔案放在 Nextcloud Files 應用程式根目錄下的「.gestion」資料夾中。記得啟用「顯示隱藏檔案」。",
    "This message will not appear on generated PDF." : "此訊息不會顯示在產生的 PDF 檔案中。",
    "To add a logo, drop the <compagnyid>logo.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "要添加徽標，請將 <compagnyid>logo.png 檔案放在 Nextcloud Files 應用程式根目錄下的「.gestion」資料夾中。記得啟用「顯示隱藏檔案」。",
    "Add product" : "添加商品",
    ...
    "To add a logo, drop the <compagnyid>logo_footer.png file in \".gestion\" folder at the root of your Nextcloud Files app. Remember to set \"Show hidden files\"." : "要添加徽標，請將 <compagnyid>logo_footer.png 檔案放在 Nextcloud Files 應用程式根目錄下的「.gestion」資料夾中。記得啟用「顯示隱藏檔案」。",
    ...
    "Loading …" : "加載中 ...",
    "First name appears in the Quote/Invoice header as a contact" : "名字在報價單/發票標題中顯示為聯繫人",
    "Last name appears in the Quote/Invoice header as a contact" : "姓名在報價單/發票標題中顯示為聯繫人",
    "Show company address in the Quote/Invoice header" : "在報價/發票標題中顯示公司地址",
    "Zip code" : "郵政編碼",
    "City name" : "城市名稱",
    ...
    "Legal Two" : "法律二",
    "Show phone number in the Quote/Invoice header" : "在報價/發票標題中顯示電郵地址",
    "Cellphone" : "手機",
    "E-mail address which appears in the header of the Quote/Invoice" : "在報價/發票標題中顯示電郵地址",
    "Mail" : "電子郵件",
    "VAT Default" : "增值稅默認值",
    "VAT number" : "增值稅編號",
    "Set prefix for generated invoice" : "為生成的賬單設置前綴",
    "Invoice prefixe" : "發票前綴",
    "Global currency for the application" : "應用程式的默認貨幣",
