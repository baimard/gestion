...
class Version3SDate20212010000001 extends SimpleMigrationStep {
	...
	public function changeSchema(IOutput $output, Closure $schemaClosure, array $options) {
        ...
        if (!$schema->hasTable('gestion_discount_devis')) {
            $table = $schema->createTable('gestion_discount_devis');
            $table->addColumn('id', 'integer', ['autoincrement' => true,'notnull' => true,]);
            $table->addColumn('devis_id', 'integer', ['length' => 11,]);
            $table->addColumn('produit_devis_id', 'integer', ['length' => 11,]);
            $table->addColumn('priority', 'integer', ['length' => 11,]);
            $table->addColumn('description', 'text', []);
            $table->addColumn('value', 'integer', ['length' => 11,]);
