require('../assets/NcModal-wPeHZkqH.css');
"use strict";
const mdi = require("../chunks/mdi-DTiP6a6e.cjs");
...
const NcActions = require("../chunks/NcActions-D51W1X9v.cjs");
const NcButton = require("../chunks/NcButton-ByTFUhwJ.cjs");
const NcIconSvgWrapper = require("../chunks/NcIconSvgWrapper-Bbl4kXZI.cjs");
const _l10n = require("../chunks/_l10n-skrZri3h.cjs");
const focusTrap = require("../chunks/focusTrap-DUTqW_IG.cjs");
const GenRandomId = require("../chunks/GenRandomId-D7iOvpZS.cjs");
const ScopeComponent = require("../chunks/ScopeComponent-BLaRYUFv.cjs");
...
_l10n.register(_l10n.t18, _l10n.t35);
...
const __injectCSSVars__ = () => {
  Vue.useCssVars((_vm, _setup) => ({
    "476657af": _vm.cssSlideshowDelay,
    "19158013": _vm.numHeaderActions
  }));
};
