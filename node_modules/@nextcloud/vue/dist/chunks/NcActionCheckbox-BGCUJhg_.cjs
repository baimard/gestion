require('../assets/NcActionCheckbox-CzUElysW.css');
"use strict";
...
const _sfc_main = {
  ...
  setup() {
    ...
    const localModel = Vue.ref(model.value);
    Vue.watch(model, (newValue) => localModel.value = newValue, { flush: "sync" });
    Vue.watch(localModel, (newValue) => model.value = newValue, { flush: "sync" });
    return {
      localModel,
      mdiCheckboxBlankOutline: mdi.mdiCheckboxBlankOutline,
      mdiCheckboxMarked: mdi.mdiCheckboxMarked
    };
  },
  methods: {
    onChange(event) {
...
//# sourceMappingURL=NcActionCheckbox-BGCUJhg_.cjs.map
