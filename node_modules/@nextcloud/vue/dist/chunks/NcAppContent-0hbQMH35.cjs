require('../assets/NcAppContent-CKJUs-ZZ.css');
"use strict";
...
const _sfc_main = {
  ...
  setup() {
    return {
      appName: appName.useAppName(),
      localizedAppName: appName.useLocalizedAppName(),
      isMobile: Composables_useIsMobile.useIsMobile(),
      isRtl
    };
  },
  ...
  methods: {
    ...
    handlePaneResize(event) {
      ...
      this.$emit("resize-list", { size: listPaneSize });
      logger.logger.debug("AppContent pane config", { size: listPaneSize });
    },
    // browserStorage is not reactive, we need to update this manually
    restorePaneConfig() {
      const listPaneSize = parseInt(browserStorage.getItem(this.paneConfigID), 10);
      if (!isNaN(listPaneSize) && listPaneSize !== this.listPaneSize) {
        logger.logger.debug("AppContent pane config", listPaneSize);
        this.listPaneSize = listPaneSize;
        return listPaneSize;
      }
    },
...
//# sourceMappingURL=NcAppContent-0hbQMH35.cjs.map
