require('../assets/NcAppNavigationItem-CksjxOVP.css');
"use strict";
...
const NcInputConfirmCancel = require("./NcInputConfirmCancel-CEZVhgJR.cjs");
const Composables_useIsMobile = require("../Composables/useIsMobile.cjs");
const GenRandomId = require("./GenRandomId-D7iOvpZS.cjs");
const NcActionButton = require("./NcActionButton-CiYel4_C.cjs");
const NcActions = require("./NcActions-D51W1X9v.cjs");
...
const _sfc_main$1 = {
  ...
  setup() {
    return { isLegacy34: legacy.isLegacy34 };
  },
  props: {
    /**
...
var _sfc_render$1 = function render3() {
  ...
  }, attrs: { "aria-label": _vm.labelButton, "variant": _vm.active && _vm.isLegacy34 ? "tertiary-on-primary" : "tertiary" }, on: { "click": _vm.onClick }, scopedSlots: _vm._u([{ key: "icon", fn: function() {
...
_l10n.register(_l10n.t22, _l10n.t52);
const _sfc_main = {
...
var _sfc_render = function render4() {
  ...
  return _c("li", { staticClass: "app-navigation-entry-wrapper", class: {
    ...
    return [_c("div", { staticClass: "app-navigation-entry", class: {
      ...
      "app-navigation-entry--legacy": _vm.isLegacy34,
...
//# sourceMappingURL=NcAppNavigationItem-0zDqIuUZ.cjs.map
