require('../assets/NcAppSidebar-B1bkEVQA.css');
"use strict";
...
const NcAppSidebarHeader = require("./NcAppSidebarHeader-D-c_yxvx.cjs");
  ...
  methods: {
    ...
    checkToggleButtonContainerAvailability() {
      if (this.open === false && !this.noToggle && !this.ncContentSelector) {
        logger.logger.warn("[NcAppSidebar] It looks like you want to use NcAppSidebar with the built-in toggle button. This feature is only available when NcAppSidebar is used in NcContent.");
      }
    },
    /**
...
//# sourceMappingURL=NcAppSidebar-DXEl0_ou.cjs.map
