...
require('../assets/NcAvatar-CK9ipsjF.css');
"use strict";
...
const userStatus = {
  ...
  methods: {
    ...
    async fetchUserStatus(userId) {
      ...
      if (!Object.hasOwn(capabilities$1, "user_status") || !capabilities$1.user_status.enabled) {
        return;
      }
...
const _sfc_main = {
  ...
  methods: {
    ...
    avatarUrlGenerator(user, size) {
      ...
      if (user === auth.getCurrentUser()?.uid && typeof window.oc_userconfig !== "undefined") {
...
//# sourceMappingURL=NcAvatar-D09ZAgeJ.cjs.map
