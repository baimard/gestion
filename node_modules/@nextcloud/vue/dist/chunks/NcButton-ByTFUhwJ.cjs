require('../assets/NcButton-o3s2D3Dl.css');
"use strict";
...
const _sfc_main = {
  ...
  render(h) {
    ...
    if (!hasText && !this.ariaLabel) {
      logger.logger.warn("You need to fill either the text or the ariaLabel props in the button component.", {
      ...
      isLink ? "a" : "button",
      {
        class: [
          ...
          `button-vue--size-${this.size}`,
          {
            ...
            "button-vue--legacy34": legacy.isLegacy34,
...
//# sourceMappingURL=NcButton-ByTFUhwJ.cjs.map
