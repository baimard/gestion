...
const _sfc_main = {
  ...
  setup(__props, { emit }) {
    ...
    return { __sfc: true, props, emit, isLoading, handleClick, t: _l10n.t, NcButton: NcButton.NcButton, NcIconSvgWrapper: NcIconSvgWrapper.NcIconSvgWrapper, NcLoadingIcon: Components_NcLoadingIcon };
  }
};
...
//# sourceMappingURL=NcDialogButton-BoetK2zm.cjs.map
