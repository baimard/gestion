require('../assets/NcRichContenteditable-DwS6PNCv.css');
"use strict";
...
const NcUserStatusIcon = require("./NcUserStatusIcon-BnGtoiCy.cjs");
const _pluginVue2_normalizer = require("./_plugin-vue2_normalizer-V0q-tHlQ.cjs");
const useModelMigration = require("./useModelMigration-D5zhrNXr.cjs");
const emoji = require("./emoji-aWWWqkrJ.cjs");
const _l10n = require("./_l10n-skrZri3h.cjs");
const Mixins_richEditor = require("./index-phHwkniW.cjs");
...
require("vue");
require("vue-router");
require("./legacy-Bk0qQxIg.cjs");
require("./NcButton-ByTFUhwJ.cjs");
const referencePickerModal = require("./referencePickerModal-BGYbZYrX.cjs");
require("./customPickerElements-GyIIOHiQ.cjs");
require("unist-builder");
require("unist-util-visit-parents");
require("./NcRichText-pqvg5l27.cjs");
require("./createElementId-lalylSCf.cjs");
require("../Components/NcEmptyContent.cjs");
require("./NcSelect-BCcSawYf.cjs");
require("../Components/NcLoadingIcon.cjs");
require("./NcTextField-B92lM77I.cjs");
...
_l10n.register(_l10n.t33, _l10n.t36);
const style1 = {
  ...
  setup() {
    ...
    if (isPlaintextOnlySupported === null) {
      try {
        ...
        logger.logger.debug("[NcRichContenteditable] Unsupported attribute value:", { error });
  ...
  methods: {
    ...
    getLink(item) {
      referencePickerModal.getLinkWithPicker(item.original.id).then((result) => {
        ...
        logger.logger.debug("Smart picker promise rejected", { error });
        const tmpElem = document.getElementById("tmp-smart-picker-result-node");
...
//# sourceMappingURL=NcRichContenteditable-DZjIiOKo.cjs.map
