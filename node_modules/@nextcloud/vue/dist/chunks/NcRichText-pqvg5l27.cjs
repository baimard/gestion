...
const _sfc_main$1 = /* @__PURE__ */ Vue.defineComponent({
  ...
  setup(__props) {
    const props = __props;
    const { copy, icon, altText } = useCopy.useCopy(() => document.getElementById(props.contentId).textContent);
    return { __sfc: true, props, copy, icon, altText, NcButton: NcButton.NcButton, NcIconSvgWrapper: NcIconSvgWrapper.NcIconSvgWrapper };
  }
});
          ...
          if (!tag.startsWith("#")) {
            ...
            if (this.useExtendedMarkdown) {
              ...
              if (tag === "pre" && Array.isArray(children) && children[0].tag === "code") {
                const id = this.parentId + "-code-block-" + GenRandomId.GenRandomId(5);
