require('../assets/NcTextArea-BtG5_qHD.css');
"use strict";
...
const _sfc_main = {
  ...
  computed: {
    ...
    isValidLabel() {
      ...
      if (!isValidLabel) {
        logger.logger.warn("You need to add a label to the NcInputField component. Either use the prop label or use an external one, as per the example in the documentation.");
      }
      return isValidLabel;
    },
    ariaDescribedby() {
...
//# sourceMappingURL=NcTextArea-B9Vn3rQC.cjs.map
