...
<div id="ConfigurationHelp" class="modal">
	<div class="modal-content">
		...
		<div class="ConfigurationHelp"><?php p($l->t('If you want to automatically generate invoice number, set to enable. If you want to be free, set disable. You can enable and disable when you want.')); ?></div>	
