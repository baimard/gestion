<div id="modalConfig" class="modalConfig">
	<div class="modal-content">
		...
		<p style="margin-bottom:20px;"><b><?php p($l->t('To start with this application you need to configure your entreprise information, follow this link'));?></b> &#128073; <a href="<?php echo($_['url']['config']); ?>"><?php p($l->t('My company'));?></a></p>
