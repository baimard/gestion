<div id="contentTable">
    ...
    <div title="<?php p($l->t('If you want to automatically generate invoice number, set to enable. If you want to be free, set disable. You can enable and disable when you want.')); ?>" class="configuration-global">
        <div class="configuration-icon icon-details"></div>
