<div id="contentTable">
    ...
    <p><?php p($l->t('This section provides information on the use of this application in accordance with the laws in various countries.')); ?></p>
    <p><?php p($l->t('If you want to contribute to this section just contact me by email')); ?> <b><a style="text-decoration:underline" href="mailto:benjamin@cybercorp.fr">Benjamin A.</a></b></p>
    <hr/>
