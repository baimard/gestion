	...
	<table id="produit" class="display tabledt">
        <thead>
            <tr>
	            ...
	            <th class="help-heading" title="<?php p($l->t('Choose S for VAT at 5.5%%, 10%% or 20%%; E for the French small-business exemption (article 293 B); Z for a legally zero-rated taxable supply; O for an operation outside the scope of VAT; AE for reverse charge; G for export outside the EU; or K for an intra-Community supply.'));?>"><?php p($l->t('VAT category (France only)'));?></th>
                ...
                <th class="help-heading" title="<?php p($l->t('Use this column to delete the product or service from the catalogue. Existing document records should remain unchanged.'));?>"><?php p($l->t('Actions'));?></th>
            </tr>
        </thead>
        <tbody>
        </tbody>
