<div syle="display: none;" id="configuration_modal" class="modal">
	<div class="modal-content">
        ...
        <div class="configuration-global"><label class="configuration" for="iban"><?php p($l->t('IBAN'));?></label><input type="text" style="float:none;width:80%;" id="iban" class="configuration-content editableConfiguration" data-table="configuration" data-column="iban" data-id="" /></div>
        ...
        <div class="configuration-global"><label class="configuration" for="logo_width"><?php p($l->t('Logo width'));?></label><input type="number" min="40" max="600" step="10" style="float:none;width:80%;" id="logo_width" class="configuration-content editableConfiguration" data-table="configuration" data-column="logo_width" data-id="" /> px</div>
        ...
        <div id="einvoice-provider-iopole" style="display:none;">
            <div class="configuration-global"><label class="configuration" for="iopole_client_id"><?php p($l->t('Client ID'));?></label><input type="text" style="float:none;width:80%;" id="iopole_client_id" class="einvoice-provider-field" autocomplete="off" /></div>
            <div class="configuration-global"><label class="configuration" for="iopole_client_secret"><?php p($l->t('Client secret'));?></label><input type="password" style="float:none;width:80%;" id="iopole_client_secret" class="einvoice-provider-field" autocomplete="new-password" /></div>
            <div class="configuration-global"><label class="configuration" for="iopole_customer_id"><?php p($l->t('Customer ID'));?></label><input type="text" style="float:none;width:80%;" id="iopole_customer_id" class="einvoice-provider-field" autocomplete="off" /></div>
            <div class="configuration-global"><label class="configuration" for="iopole_base_url"><?php p($l->t('API URL'));?></label><input type="url" style="float:none;width:80%;" id="iopole_base_url" class="einvoice-provider-field" placeholder="https://…" /></div>
            <div class="configuration-global"><label class="configuration" for="iopole_auth_url"><?php p($l->t('Authentication URL'));?></label><input type="url" style="float:none;width:80%;" id="iopole_auth_url" class="einvoice-provider-field" placeholder="https://…" /></div>
        </div>
