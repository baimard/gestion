<div syle="display: none;" id="configuration_modal" class="modal">
	<div class="modal-content">
        ...
        <div title="<?php p($l->t('Global currency for the application')); ?>" class="configuration-global">
            <div class="configuration-icon icon-details"></div>
            <select style="float:none;width:80%;" id="currency" class="configuration-content editableSelect" data-table="configuration" data-column="devise" data-id=""></select>
        </div>

        <!-- Format Select -->
        <div title="<?php p($l->t('Global monetary format for the application')); ?>" class="configuration-global">
            <div class="configuration-icon icon-details"></div>
            <select style="float:none;width:80%;" id="format" class="configuration-content editableSelect" data-table="configuration" data-column="format" data-id=""></select>
        </div>
