...
return array(
    'Atgp\\FacturX\\Exceptions\\ExceptionInterface' => $vendorDir . '/atgp/factur-x/src/Exceptions/ExceptionInterface.php',
    'Atgp\\FacturX\\Exceptions\\Reader\\EmbeddedFileNotReadableException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Reader/EmbeddedFileNotReadableException.php',
    'Atgp\\FacturX\\Exceptions\\Reader\\FilespecNotFoundException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Reader/FilespecNotFoundException.php',
    'Atgp\\FacturX\\Exceptions\\Reader\\InvalidXmlException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Reader/InvalidXmlException.php',
    'Atgp\\FacturX\\Exceptions\\Reader\\ReaderExceptionInterface' => $vendorDir . '/atgp/factur-x/src/Exceptions/Reader/ReaderExceptionInterface.php',
    'Atgp\\FacturX\\Exceptions\\Writer\\InvalidAttachmentException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Writer/InvalidAttachmentException.php',
    'Atgp\\FacturX\\Exceptions\\Writer\\InvalidProfileException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Writer/InvalidProfileException.php',
    'Atgp\\FacturX\\Exceptions\\Writer\\InvalidRelationshipException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Writer/InvalidRelationshipException.php',
    'Atgp\\FacturX\\Exceptions\\Writer\\InvalidXmlException' => $vendorDir . '/atgp/factur-x/src/Exceptions/Writer/InvalidXmlException.php',
    'Atgp\\FacturX\\Exceptions\\Writer\\WriterExceptionInterface' => $vendorDir . '/atgp/factur-x/src/Exceptions/Writer/WriterExceptionInterface.php',
    'Atgp\\FacturX\\Exceptions\\XsdValidator\\InvalidProfileException' => $vendorDir . '/atgp/factur-x/src/Exceptions/XsdValidator/InvalidProfileException.php',
    'Atgp\\FacturX\\Exceptions\\XsdValidator\\InvalidXmlException' => $vendorDir . '/atgp/factur-x/src/Exceptions/XsdValidator/InvalidXmlException.php',
    'Atgp\\FacturX\\Exceptions\\XsdValidator\\XsdValidationFailureException' => $vendorDir . '/atgp/factur-x/src/Exceptions/XsdValidator/XsdValidationFailureException.php',
    'Atgp\\FacturX\\Exceptions\\XsdValidator\\XsdValidatorExceptionInterface' => $vendorDir . '/atgp/factur-x/src/Exceptions/XsdValidator/XsdValidatorExceptionInterface.php',
    'Atgp\\FacturX\\Fpdi\\FdpiFacturx' => $vendorDir . '/atgp/factur-x/src/Fpdi/FdpiFacturx.php',
    'Atgp\\FacturX\\Reader' => $vendorDir . '/atgp/factur-x/src/Reader.php',
    'Atgp\\FacturX\\Utils\\Exception\\ProfileResolutionException' => $vendorDir . '/atgp/factur-x/src/Utils/Exception/ProfileResolutionException.php',
    'Atgp\\FacturX\\Utils\\ProfileHandler' => $vendorDir . '/atgp/factur-x/src/Utils/ProfileHandler.php',
    'Atgp\\FacturX\\Writer' => $vendorDir . '/atgp/factur-x/src/Writer.php',
    'Atgp\\FacturX\\XsdValidator' => $vendorDir . '/atgp/factur-x/src/XsdValidator.php',
